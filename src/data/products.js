export const products = [
  ...
  },
  {
    ...
    price: 179,
    description:
      "3D NAND flash are applied to deliver high transfer speeds Remarkable transfer faster bootup and improved overall system performance. The advanced SLC Cache Technology allows performance boost and longer lifespan 7mm slim design suitable for Ultrabooks and Ultra-slim notebooks.",
    category: "electronics",
  ...
  },
  {
    ...
    price: 220,
    description:
      "CURVED GAMING MONITOR with dual 27 inch screen side by side QUANTUM DOT (QLED) TECHNOLOGY, HDR support and factory calibration provides stunningly realistic and accurate color and 1ms ultra fast response time work to eliminate motion blur, ghosting, and reduce input lag",
    category: "electronics",
